...
HD_PWD='D:/GitCode/SketchSystem_Multi1080p/SketchSystem.runs/system_SketchIP_1080p_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_SketchIP_1080p_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_SketchIP_1080p_0_0.tcl
